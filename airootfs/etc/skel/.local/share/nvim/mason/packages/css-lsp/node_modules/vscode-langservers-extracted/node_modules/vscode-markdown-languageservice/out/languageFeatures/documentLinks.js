...
exports.MdLinkProvider = exports.MdLinkComputer = void 0;
...
function createHref(sourceDocUri, link, workspace) {
    if (/^[a-z\-][a-z\-]+:/i.test(link)) {
        ...
        try {
            ...
            console.warn((0, string_1.r) `Failed to parse link ${link} in ${sourceDocUri.toString(true)}`);
            return undefined;
        }
    }
...
function createMdLink(document, targetText, preHrefText, rawLink, matchIndex, fullMatch, titleMatch, workspace) {
    ...
    if (titleMatch) {
        ...
        if (indexOfTitleInLink >= 0) {
            ...
            titleRange = lsp.Range.create(document.positionAt(titleStartOffset), document.positionAt(titleStartOffset + titleMatch.length));
        }
    }
    return {
...
function getLinkSourceFragmentInfo(document, link, linkStart, linkEnd) {
    ...
    return {
        hrefPathText: document.getText({ start: linkStart, end: fragmentRange ? (0, position_1.translatePosition)(fragmentRange.start, { characterDelta: -1 }) : linkEnd }),
        ...
        for (const match of text.matchAll(referenceLinkPattern)) {
            ...
            yield {
                ...
                source: {
                    ...
                    resource: (0, textDocument_1.getDocUri)(document),
                    range: { start: linkStart, end: linkEnd },
                    targetRange: lsp.Range.create((0, position_1.translatePosition)(hrefStart, { characterDelta: -1 }), (0, position_1.translatePosition)(hrefEnd, { characterDelta: 1 })),
